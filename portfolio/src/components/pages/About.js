  ...
  return (
    <div className="bg-blue-500 p-10 max-w-lg">
      ...
      <p>
        ...
        qualifications necessary to do so, I have learned many transferable
        skills, from working under pressure in a kitchen and within strict time
        constraints, to strong people skills and risk management in the front of
